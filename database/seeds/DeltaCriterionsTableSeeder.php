...
class DeltaCriterionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('delta_criterions')->insert([
            ...
            'dk3_3_explain' => 'Ξεκάθαρη δομημένη και εύχρηστη διάταξη: Είναι εύκολο να εντοπιστούν όλα τα σημαντικά στοιχεία. Λευκός χώρος, γραφικά στοιχεία ή/και ευθυγράμμιση χρησιμοποιούνται αποτελεσματικά για να οργανώσουν το υλικό.',

            'dk5_1_explain' => 'Δείτε παραδείγματα στο http://en.wikipedia.org/wiki/Semantic_URL.',
            'dk5_3_explain' => 'Favicon: μικρό εικονίδιο που εμφανίζεται στη μπάρα της διεύθυνσης του προγράμματος πλοήγησης.',
