...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'languages_other' => [
            'required_with' => 'Εφόσον έχετε συμπληρώσει το επίπεδο, θα πρέπει να συμπληρώσετε και την γλώσσα ή τις γλώσσες.'
        ],
        'languages_other_level' => [
            'required_with' => 'Εφόσον έχετε συμπληρώσει την γλώσσα ή τις γλώσσες, θα πρέπει να συμπληρώσετε και το επίπεδο.'
        ],
        'why_propose_myself' => [
            'required_if' => 'Εφόσον έχετε επιλέξει ότι αυτοπροτείνεστε, θα πρέπει να σημπληρώσετε και τους λόγους.'
        ],
        'i_agree' => [
            'accepted' => 'Πριν συνεχίσετε, θα πρέπει πρώτα να συμφωνήσετε.'
        ],
        'received_permission' => [
            'required_if' => 'Εφόσον προβάλλει ο ιστότοπος προσωπικά δεδομένα παιδιών, θα πρέπει να επιλέξετε και έαν έχετε λάβει γραπτή άδεια ή όχι.'
        ],
        'restricted_access_details' => [
            'required_if' => 'Εφόσον ο ιστότοπος έχει περιορισμένη πρόσβαση, θα πρέπει να δώσετε και τις πληροφορίες πρόσβασης.'
        ],
        'desired_category' => [
            'required' => 'Θα πρέπει να επιλέξετετε τουλάχιστον μία κατηγορία.'
        ],
        'teaching_xp' => [
            'required' => 'Θα πρέπει να επιλέξετετε τουλάχιστον μία κατηγορία.'
        ],
        'why_cannot_evaluate' => [
            'required_if' => 'Εφόσον ΔΕΝ αποδέχεστε, θα πρέπει να το αιτιολογήσετε.'
        ],
        'why_not_educational' => [
            'required_if' => 'Εφόσον ΔΕΝ θεωρείτε τον ιστότοπο εκπαιδευτικό, θα πρέπει να το αιτιολογήσετε.'
        ],                
    ],
