...
<h1 class="bg-success" style="padding: .5em 1em; margin-bottom: 1.5em">Φάση Β - Βαθμολογίες Υποψήφιων Ιστότοπων</h1>
...
<table id="sitesgrades-a-table" class="table table-striped admin-table">
  ...
  <tbody>
    @foreach($sites as $site)
      ...
      @if($site->user->hasRole('site') && in_array($site->id, $winners_a))

        <?php $evaluations = App\Evaluation_b::where('site_id', $site->id)->get(); ?>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="{{ route('assign_evaluation_site_b_grader_b', [$site->id, 'sites_grades_b']) }}" role="button">Ανάθεση σε Αξ. Β</a>
            </td>
