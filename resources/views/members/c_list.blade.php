...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
    ...
    @foreach($cats as $cat)
        ...
        <div class="btn-group" role="group">
            <a href="{{ route('admin.c_list', $cat) }}" type="button" class="btn btn-{{ $cat_color[$cat] }} btn-lg">
                Κατηγορία {{ $cat }}
            </a>
        </div>
...
<div class="container">
    <table id="c-list-table" class="table table-striped admin-table">
        ...
        @foreach($sites as $site)
            @if(in_array($site->id, $winners_b))
                <tr>
                    ...
                    <?php $total_grades = $site->total_grades('c') ?>
