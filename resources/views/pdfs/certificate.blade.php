                    ...
                    @if($type == 'site')
                        <tr>
                            <td colspan="2" style="padding: 10px 0">
                                Στον Ιστότοπο: <strong>{{ $title }}</strong>
                            </td>
                        </tr>
                    @endif
                    <tr>
                        <td colspan="2" style="padding: 10px 0">
                            ...
                            @endif
                            @if($type == 'grader')
                                Βεβαιώνεται ότι ο/η κ. <strong>{{ $title }}</strong> ήταν αξιολογητής/τρια 
                            @endif
                            @if($type == 'member')
                                Βεβαιώνεται ότι ο/η κ. <strong>{{ $title }}</strong> ήταν μέλος της Οργανωτικής - Επιστημονικής Επιτροπής 
                            @endif
                            στον <strong>8ο Διαγωνισμό Ελληνόφωνων Εκπαιδευτικών Ιστότοπων,</strong> ο οποίος έγινε στο πλαίσιο του 9ου Πανελλήνιου Συνεδρίου των Εκπαιδευτικών για τις Τεχνολογίες της Πληροφορίας και της Επικοινωνίας.
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 18px 0 8px 0">
                            Σύρος, 30 Απριλίου 2017
                        </td>
                    </tr>
                    <tr>
                        <td class="small">
