    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h4>Καρτέλα Υποψηφιότητας</h4></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('sites.update', ['sites' => $site->id]) }}">
                        ...
                        <div class="col-md-12 form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                            ...
                            <input type="url" class="form-control" id="url" name="url" value="{{ $site->url }}">
                        ...
                        <div class="col-md-12 form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <input type="title" class="form-control" id="title" name="title" value="{{ $site->title  }}">
                        ...
                        <div class="col-md-12 form-group{{ $errors->has('cat_id') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" id="cat_id" name="cat_id" value="{{ old('cat_id') }}">
                                @foreach($categories::all() as $name => $cat_id)
                                    <option value="{{ $cat_id }}" @if($cat_id == $site->cat_id) selected @endif>{{ $name }}</option>
                                @endforeach
                            </select>
