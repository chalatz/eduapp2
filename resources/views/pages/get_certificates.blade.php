            ...
            <table class="table table-striped">
                @if(in_array('site', $type))
                    <tr>
                        ...
                        <td>
                            Εάν δεν είναι σωστή η ονομασία του Ιστοτόπου σας, παρακαλούμε επικοινήστε μαζί μας στο <strong>info@eduwebawards.gr</strong>
                        </td>
                    </tr>
                @endif
                ...
                @if(in_array('grader', $type))
                    <tr>
                        ...
                        <td>
                            Εάν δεν είναι σωστό το ονοματεπώνυμό σας, παρακαλούμε επικοινήστε μαζί μας στο <strong>info@eduwebawards.gr</strong>
                        </td>
                    </tr>
                @endif
