        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            @if(isset($suggestions_count))
                ...
                <div class="alert alert-warning lead" role="alert">
                    ...
                    @endif
                    @if($suggestions_count > 1)
                        Έχετε ήδη αποδεχθεί πρσκλήσεις Αξιολογητή άλλες {{ $suggestions_count }} φορές. Παρακαλούμε αποδεχτείτε μόνον εάν είστε διατεθιμένος να αξιολογήσετε ισάριθμους Ιστότοπους, μέσα στους προβλεπόμενους χρόνους.
                    @endif
                </div>
