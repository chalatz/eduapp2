...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <p class="lead">
                URL υποψήφιου Ιστότοπου: <strong>{{ $suggestion->suggestor_url }}</strong>
            </p>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="alert alert-warning lead" role="alert">
                    <?php $xtimes =  ($suggestions_count + 1) * 2; ?>
                    @if($suggestions_count == 1)
                        Έχετε ήδη αποδεχθεί πρόσκληση Αξιολογητή άλλη μία φορά. Παρακαλούμε αποδεχτείτε μόνον εάν είστε διατεθιμένος να αξιολογήσετε {{ $xtimes }} Ιστότοπους, μέσα στους προβλεπόμενους χρόνους.
                    @endif
                    @if($suggestions_count > 1)
                        Έχετε ήδη αποδεχθεί προσκλήσεις Αξιολογητή άλλες {{ $suggestions_count }} φορές. Παρακαλούμε αποδεχτείτε μόνον εάν είστε διατεθιμένος να αξιολογήσετε {{ $xtimes }} Ιστότοπους, μέσα στους προβλεπόμενους χρόνους.
                    @endif
                </div>
            </div>
        </div>
