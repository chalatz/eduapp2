<div class="container">
    <div class="col-md-10">
        {!! Form::model($evaluation, ['method' => 'PUT','route' => ['is_educational_b_submit', $evaluation->id], 'class' => 'form-horizontal', 'id' => 'confirmAlpha-'.$site_index, 'name' => 'confirmAlpha-'.$site_index, 'data-parsley-validate']) !!}
