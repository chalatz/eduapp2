<div class="container">
    <div class="col-md-10">
        {!! Form::model($evaluation, ['method' => 'PUT','route' => ['can_evaluate_c_submit', $evaluation->id], 'class' => 'form-horizontal', 'id' => 'confirmCanEvaluate-'.$site_index, 'name' => 'confirmCanEvaluate-'.$site_index, 'data-parsley-validate']) !!}
