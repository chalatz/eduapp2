                    ...
                    <div class="panel panel-{{ $color_panel }}">
                        ...
                        <div class="panel-body">
                            ...
                            @if($evaluation->can_evaluate == 'na')
                                @include('evaluations.can_evaluate_b_form')
                            @endif
                            ...
                            @if($evaluation->can_evaluate == 'yes')
                                    ...
                                    @if($evaluation->finalized != 'yes')
                                        ...
                                        <div class="panel panel-default" style="margin: 1em 0">
                                            <div class="panel-body">
                                                ...
                                                <a href="{{ route('evaluate_b_edit', [Auth::user()->id, 'beta', $grader->id, $evaluation->site_id]) }}" type="button" class="btn btn-info btn-block btn-lg">
                                        ...
                                        <div class="panel panel-default" style="margin: 1em 0">
                                            <div class="panel-body">
                                                <a href="{{ route('evaluate_b_edit', [Auth::user()->id, 'gama', $grader->id, $evaluation->site_id]) }}" type="button" class="btn btn-info btn-block btn-lg">
                                        ...
                                        <div class="panel panel-default" style="margin: 1em 0">
                                            <div class="panel-body">
                                                ...
                                                <a href="{{ route('evaluate_b_edit', [Auth::user()->id, 'delta', $grader->id, $evaluation->site_id]) }}" type="button" class="btn btn-info btn-block btn-lg">
                                        ...
                                        <div class="panel panel-default" style="margin: 1em 0">
                                            <div class="panel-body">
                                                ...
                                                <a href="{{ route('evaluate_b_edit', [Auth::user()->id, 'epsilon', $grader->id, $evaluation->site_id]) }}" type="button" class="btn btn-info btn-block btn-lg">
                                        ...
                                        <div class="panel panel-default" style="margin: 1em 0">
                                            <div class="panel-body">
                                                <a href="{{ route('evaluate_b_edit', [Auth::user()->id, 'st', $grader->id, $evaluation->site_id]) }}" type="button" class="btn btn-info btn-block btn-lg">
                                        ...
                                        @if($evaluation->beta_grade > 0 && $evaluation->gama_grade > 0 && $evaluation->delta_grade > 0 && $evaluation->epsilon_grade > 0 && $evaluation->st_grade > 0)
                                            <a href="{{ route('evaluation_b.finalize', $evaluation->id) }}" type="button" class="btn btn-success btn-block btn-lg" onclick="return confirm('Εϊστε σίγουρος;');">
                                ...
                                @else
                                    @include('evaluations.is_educational_b_form')
                                @endif
                        ...
                        @if($evaluation->can_evaluate == 'yes' && $evaluation->finalized != 'yes')
                            <div class="panel-footer">
                                @include('evaluations.site_comment_form_b')
                            </div>
                        @endif                    
