...
<div class="container">
    <div class="col md-12">
        ...
        <p><strong><a href="{{ route('evaluation_c.show') }}">&larr; Επιστροφή στις Αναθέσεις Μου</a></strong></p>

        {!! Form::model($evaluation, ['method' => 'PATCH','route' => ['evaluation_c.update', $evaluation->id], 'class' => 'form-horizontal', 'id' => 'evaluation_update', 'name' => 'evaluation_update', 'data-parsley-validate']) !!}
