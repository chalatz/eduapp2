...
<div style="padding: 0 2em;">
    ...
    <p style="font-size: 1.5em">
        <a href="{{ route('sites_grades_b') }}">&larr; Επιστροφή στις Αναθέσεις Β</a>
    </p>
    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach(App\Evaluation_b::where('site_id', $site->id)->get() as $evaluation)
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>
                                            <a class="btn btn-info" href="{{ route('send_extra_to_grader_b', [$evaluation->id]) }}" role="button" onclick="return confirm('Εϊστε σίγουρος;');">
                                                Αποστολή email για την Ανάθεση (ΝΕΑ - Αξιολογητής Β)
                                            </a>
                                        </p>
                                        <p>
                                            <a class="btn btn-warning" href="{{ route('send_extra_to_grader_b_20pc', [$evaluation->id]) }}" role="button" onclick="return confirm('Εϊστε σίγουρος;');">
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::open(['route' => 'evaluations.store_manual_b', 'class' => 'form-horizontal', 'role' => 'form', 'data-parsley-validate']) !!}
