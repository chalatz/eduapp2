...
@section('content')
    ...
    <h3>ΥΠΕΝΘΥΜΙΣΗ ΓΙΑ ΟΛΟΚΛΗΡΩΣΗ ΒΑΘΜΟΛΟΓΙΑΣ</h3>
    ...
    <p>
        Σας υπενθυμίζουμε να <strong>ολοκληρώσετε την αξιολόγηση</strong> των ιστότοπων που σας έχουν ανατεθεί, <strong>μέχρι την Τρίτη 28/2/2017, στις 22:00 μ.μ.​</strong>
    </p>

    <p>
        Παρακαλούμε να έχετε υπόψη σας ότι αν <strong>δεν</strong> ολοκληρώσετε τις αξιολογήσεις σας ​μέχρι την συγκεκριμένη ημερομηνία, ο υποψήφιος Ιστότοπος που σας πρότεινε, <a href="http://2017.eduwebawards.gr/evaluation/">σύμφωνα με τον κανονισμό</a>, <strong>θα αποκλειστεί από τον διαγωνισμό.</strong>
    </p>
