                                    ...
                                    <table class="twelve columns">
                                       <tr>
                                          <td>
                                             ...
                                             <p>
                                                Έχετε προταθει ως Αξιολογητής Α από τον <strong>{{ $data['suggestor_name'] }}</strong>, με email {{ $data['suggestor_email'] }} με το μήνυμα:
                                             </p>
                                             <p>
                                                {!! nl2br(e($data['personal_msg'])) !!}
                                             </p>
                                             <p>Για να να αποδεχτείτε ή όχι, πατήστε σε αυτόν τον σύνδεσμο:</p>
