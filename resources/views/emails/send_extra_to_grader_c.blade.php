...
@section('content')
    ...
    <h3>ΦΑΣΗ Γ - ΑΝΑΘΕΣΗ ΙΣΤΟΤΟΠΩΝ ΣΕ ΑΞΙΟΛΟΓΗΤΗ Β {{ App\Config::first()->index }}ου ΔΕΕΙ</h3>
    ...
    <p>
        Σας έχουμε αναθέσει <strong>έναν νέο Ιστότοπο</strong> για να αξιολογήσετε, <strong>για τη Φάση Γ του διαγωνισμού.</strong>
    </p>
    ...
    <p>
        Εάν υπάρχει πολύ σοβαρός λόγος για την αυτο-εξαίρεσή σας, έχετε τη δυνατότητα να δηλώσετε ότι δεν μπορείτε να αναλάβετε την αξιολόγηση αυτού του ιστότοπου.
    </p>
