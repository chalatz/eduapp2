                              ...
                              <tr>
                                 <td class="wrapper last">
                                    <table class="twelve columns">
                                       <tr>
                                          <td>
                                             <h3>Άρνηση από τον Αξιολογητή Α</h3>
                                             <p>
                                                Σας ενημερώνουμε ότι ο/η <strong>{{ $data['name'] }}</strong> και με email {{ $data['email'] }} <strong>έχει αρνηθεί</strong> την πρόσκλησή σας για Αξιολογητής Α.
                                             </p>
                                             <p>
                                                Παρακαλούμε συνδεθείτε στο <a href="{{ route('home') }}">Πληροφοριακό Σύστημα του Διαγωνισμού</a> και προτείνετε είτε νέο Αξιολογητή Α είτε τον εαυτό σας.
                                             </p>
                                          </td>
                                          <td class="expander"></td>
                                       </tr>
