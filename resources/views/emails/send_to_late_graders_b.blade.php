...
@section('content')
    ...
    <h3>Β ΦΑΣΗ - ΥΠΕΝΘΥΜΙΣΗ ΓΙΑ ΚΡΙΣΗ</h3>
    ...
    <p>
        Σας υπενθυμίζουμε να αποδεχτείτε την πρόσκλησή μας να αξιολογήσετε τους ιστότοπους που σας έχουν ανατεθεί και να ολοκληρώσετε την αξιολόγησή τους <strong>μέχρι την Τετάρτη 5/4/2017, στις 22:00 μ.μ.​</strong>
    </p>

    <p>
        Εφόσον συντρέχει σοβαρός λόγος και δεν μπορείτε να ολοκληρώσετε τις αξιολογήσεις σας, παρακαλούμε να μας <strong>ενημερώσετε άμεσα.</strong>
    </p>
