...
@section('content')
    ...
    <h3>ΦΑΣΗ Γ - ΑΝΑΘΕΣΗ ΙΣΤΟΤΟΠΩΝ ΣΕ ΤΡΙΤΟ ΑΞΙΟΛΟΓΗΤΗ {{ App\Config::first()->index }}ου ΔΕΕΙ</h3>
    ...
    <p>
        Σας ενημερώνουμε ότι μετά την αξιολόγηση του παρακάτω ιστότοπου, <strong>παρατηρήθηκε διαφορά βαθμολογίας >20%,</strong> και σύμφωνα με τους όρους του διαγωνισμού, καλείται και τρίτος αξιολογητής.
    </p>
    ...
    <p>
        Παρακαλούμε συνδεθείτε στο πληροφοριακό σύστημα του {{ App\Config::first()->index }}ου ΔΕΕΙ (<a href="http://www.eduwebawards.gr/app2/public/">http://www.eduwebawards.gr/app2/public/</a>) και πατήστε <strong>Γ Φάση: Έναρξη Αξιολόγησης.</strong>
    </p>
    ...
    <p>
        Εάν υπάρχει πολύ σοβαρός λόγος για την αυτο-εξαίρεσή σας, έχετε τη δυνατότητα <strong>το συντομότερο</strong> να δηλώσετε ότι δεν μπορείτε να αναλάβετε την αξιολόγηση αυτού του ιστότοπου για αυτό το λόγο και να σας αλλάξουμε τον ιστότοπο.
    </p>
