...
@section('content')
    ...
    <p>
        Σας παρακαλoύμε να αποδεχτείτε την πρόσκλησή μας να αξιολογήσετε τους ιστότοπους:
    </p>
    ...
    <p>
        Σας παρακαλούμε να έχετε συνδεθεί μέχρι τις <strong>9 Φεβρουαρίου 2017</strong> και να αποδεχτείτε να αξιολογήσετε τους ιστότοπους που σας έχουν ανατεθεί.
    </p>
    ...
    <p>
        Σας παρακαλoύμε να έχετε ολοκληρώσει τις αξιολογήσεις σας μέχρι τις <strong>17 Φεβρουαρίου 2017, ημέρα Παρασκευή.</strong>
    </p>
