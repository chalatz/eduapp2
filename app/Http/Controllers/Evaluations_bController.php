...
class Evaluations_bController extends Controller
{
    public function __construct()
        {
            $this->middleware('verified');

            $this->middleware('phase_b', ['except' => [
                'init',
            ...
            $this->middleware('must_own_evaluation_b', ['only' => 'edit']);
    ...
    public function show()
    {
        ...
        $evaluations = Evaluation_b::where('grader_id', $grader->id)->where('can_evaluate', '!=', 'no')->get();
    ...
    public function init()
    {
        ...
        if($status == 'on'){
            ...
            foreach($assignments as $assignment){
                ...
                $data['assigned_at'] = '2017-03-20';
                $data['assigned_until'] = '2017-03-27';
        ...
        return "evaluations B initialized";
