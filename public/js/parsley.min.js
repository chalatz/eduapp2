...
Parsley.addMessages('el', {
  ...
  minlength:      "Το πεδίο πρέπει να αποτελείται από τουλάχιστον %s χαρακτήρες.",
  ...
  check:          "Πρέπει να επιλέξετε μεταξύ %s και %s επιλογών.",
  equalto:        "Δεν συμφωνεί το πεδίο με την επιβεβαίωσή του."
});
